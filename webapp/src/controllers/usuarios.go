...
func EditarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	response, erro := requisicoes.FazerRequsicaoComAutentificacao(r, http.MethodPut, url, bytes.NewBuffer(usuario))
	if erro != nil {
		respostas.JSON(w, http.StatusInternalServerError, respostas.ErroAPI{Erro: erro.Error()})
		return
	}
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	response, erro := requisicoes.FazerRequsicaoComAutentificacao(r, http.MethodPost, url, bytes.NewBuffer(senhas))
	if erro != nil {
		respostas.JSON(w, http.StatusInternalServerError, respostas.ErroAPI{Erro: erro.Error()})
		return
	}
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	url := fmt.Sprintf("%s/usuarios/%d", config.ApiUrl, usuarioID)
	response, erro := requisicoes.FazerRequsicaoComAutentificacao(r, http.MethodDelete, url, nil)
	if erro != nil {
		respostas.JSON(w, http.StatusInternalServerError, respostas.ErroAPI{Erro: erro.Error()})
		return
	}
