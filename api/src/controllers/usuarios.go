...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoTOken != usuarioId {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel atualizar a senha de um usuarios que não seja o seu"))
		return
	}
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("A senha atual não corresponde com a que esta salva no banco "))
		return
	}
