...
func (repositorio Usuarios) Seguir(usuarioID, seguidorID uint64) error {
	statament, erro := repositorio.db.Prepare("insert ignore into seguidores (usuario_id, seguidor_id) values (?, ?)")
	...
	if _, erro = statament.Exec(usuarioID, seguidorID); erro != nil {
		return erro
	}
	return nil
}
...
// Buscar senha traz a senha de um usuario por ID
...
// Atualizar senha altera a senha de um usuario
